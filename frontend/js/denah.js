export const DENAH = [
  ...
  ["2605","E205","86261342298","DEPAN 4 (3)"], ["1509","D107","86261269285","DEPAN 4 (3)"], ["1605","E105","86261313067","DEPAN 4 (4)"], ["G505","DG05","86261311640"],
  // TENGAH 1 BAWAH
  ["3305","C305","86261313075","DEPAN 4 (1)"], ["3307","C307","86261292576","DEPAN 4 (2)"], ["3509","D307","86261269194","DEPAN 4 (1)"], ["3605","E305","86261311566","DEPAN 4 (2)"], 
...
export const meterToRoom = new Map();
...
export function resolveRoomOrCode(token){
  ...
  if (meterToRoom.has(t)) {
    const room = meterToRoom.get(t);
    return {
      room,
      code: codeByRoom.get(room) ?? "-"
    };
  }
