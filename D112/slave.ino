...
uint8_t macA[6] = {0x30,0xC6,0xF7,0x45,0x0B,0xFC}; // Ganti ke MAC Modul A
uint8_t macB[6] = {0xB0,0xA7,0x32,0x34,0x39,0xC0}; // Ganti ke MAC Modul B
uint8_t macC[6] = {0xB0,0xA7,0x32,0x34,0x39,0x5C}; // Ganti ke MAC Modul C
...
Channel channels[] = {
    ...
    {11, macB, 5, false, "bt_11"}, {13, macC, 1, false, "bt_13"}, {15, macA, 3, false, "bt_15"},
    {14, macC, 2, false, "bt_14"}, {20, macC, 2, false, "bt_20"}, {1, macA, 1, false, "bt_1"},
    {2, macA, 4, false, "bt_2"}, {16, macC, 4, false, "bt_16"}, {17, macC, 5, false, "bt_17"},
